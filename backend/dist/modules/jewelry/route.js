...
async function jewelryRoutes(app) {
    // GET current gold/silver rates +
    // store making charges config
    app.get('/:storeId/jewelry-config', { preHandler: pre }, handler.getJewelryConfig);
    // PATCH store jewelry settings
    // (making charges, festival discount,
    // manual rate override)
    app.patch('/:storeId/jewelry-config', { preHandler: pre }, handler.updateJewelryConfig);
}
